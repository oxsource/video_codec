...
// and nothing internal. See specs/003-core-utils-public-api/contracts/public-api.md.
//
...
// individual API types below are not yet decorated with VIDEO_CODEC_API; tagging
// them for shared-library export is a tracked follow-up. Static builds are the
