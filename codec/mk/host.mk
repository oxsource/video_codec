...
$(call register_target,host_ffmpeg_example)
$(call register_target,host-verify)

.PHONY: host-build host-spike host_ffmpeg_example host-verify
...
host_ffmpeg_example: ## Run the ffmpeg_encode_file demo (SMPTE color bars -> .h264) + ffprobe assert
	bash $(V)/host_ffmpeg_example.sh

host-verify: ## Full host validation: build + spike + ffmpeg_encode_file example + ffprobe asserts
