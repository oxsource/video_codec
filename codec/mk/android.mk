# Android verification module (spec 006 MediaCodec backend + spec 007 input
# surface), isolation steps (research R6/R8):
...
# - android-surface: full A/V mux via the hardware input surface (spec 007)
...
# the cross-build and a connected device for the raw/run/surface modes (see
