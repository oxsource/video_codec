...
├── io/          # ByteWriter 输出契约 + FileWriter/StreamWriter/TeeWriter
├── consumer/    # PacketConsumer, FileSinkConsumer, Mp4Consumer（io::ByteWriter + Mp4Muxer）
├── mux/         # Mp4Muxer 纯格式封装（libavformat），输出到 io::ByteWriter
